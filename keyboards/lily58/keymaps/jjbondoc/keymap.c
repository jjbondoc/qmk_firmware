...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[4] = LAYOUT(
		...
		KC_LCTL, 	KC_Z, 	  KC_X, 	KC_C, 	  KC_V, 	KC_B,     KC_NO,    KC_NO, 	  KC_N, 	KC_M, 	  KC_COMM,  KC_DOT,   KC_SLSH,  TG(4),
										KC_LGUI,  KC_LALT,  KC_SPC,   MO(5),    KC_NO,    KC_BSPC,  KC_ENT,   KC_RSFT
		//-------------------------------------------------------------------|---------------------------------------------------------------------- 
	),
	...
	[5] = LAYOUT(
		...
		KC_ESC,     KC_6, 	  KC_7, 	KC_8, 	  KC_9, 	KC_0, 						  KC_NO, 	KC_NO, 	  KC_NO, 	KC_NO, 	  KC_NO, 	KC_NO,
		KC_TRNS, 	KC_1, 	  KC_2, 	KC_3, 	  KC_4, 	KC_5, 						  KC_NO, 	KC_NO, 	  KC_NO, 	KC_NO, 	  KC_NO, 	KC_NO,
		KC_TRNS, 	KC_F6, 	  KC_F7, 	KC_F8, 	  KC_F9, 	KC_F10,   KC_F11,   KC_F12,   KC_NO, 	KC_NO, 	  KC_NO, 	KC_NO, 	  KC_NO, 	KC_NO,
